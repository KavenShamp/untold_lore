...
public class Modelchampion_helmet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("untold_lore", "modelchampion_helmet"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition brute_plates = brute_helm.addOrReplaceChild("brute_plates",
				CubeListBuilder.create().texOffs(1, 28).addBox(-2.0F, -28.0F, -5.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.1F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition visor_r1 = brute_plates.addOrReplaceChild("visor_r1",
				CubeListBuilder.create().texOffs(0, 22).addBox(-6.0F, -30.0F, -12.0F, 12.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_r1 = brute_plates.addOrReplaceChild("right_r1",
				CubeListBuilder.create().texOffs(37, 18).addBox(-16.0F, -26.0F, -5.0F, 1.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0873F, 0.0F, 0.3491F));
		PartDefinition left_r1 = brute_plates
				.addOrReplaceChild(
						"left_r1", CubeListBuilder.create().texOffs(37, 18).mirror()
		...
		PartDefinition deco = brute_helm.addOrReplaceChild("deco",
				CubeListBuilder.create().texOffs(26, 10).addBox(-0.5F, -34.0F, -1.0F, 1.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(1, 21)
		...
		PartDefinition tusk_left_r1 = deco.addOrReplaceChild("tusk_left_r1",
				CubeListBuilder.create().texOffs(2, 1).mirror().addBox(2.12F, -28.0F, 3.25F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(2, 1).addBox(-3.12F, -28.0F, 3.25F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
