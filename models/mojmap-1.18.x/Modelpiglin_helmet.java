...
public class Modelpiglin_helmet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "piglin_helmet"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition brute_plates = brute_helm.addOrReplaceChild("brute_plates", CubeListBuilder.create()
				.texOffs(24, 3).addBox(-2.0F, -27.85F, -5.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.15F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition right_r1 = brute_plates
				.addOrReplaceChild("right_r1",
						CubeListBuilder.create().texOffs(27, 16).addBox(-15.0F, -27.0F, -2.0F, 1.0F, 5.0F, 4.0F,
		...
		PartDefinition brute_torse = brute_helm.addOrReplaceChild("brute_torse", CubeListBuilder.create().texOffs(0, 16)
				.addBox(-4.5F, -31.0F, -4.5F, 9.0F, 1.0F, 9.0F, new CubeDeformation(0.1F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
