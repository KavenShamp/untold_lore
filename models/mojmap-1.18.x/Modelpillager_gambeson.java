...
public class Modelpillager_gambeson<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "pillager_gambeson"), "main");
	private final ModelPart right;
	private final ModelPart left;
	private final ModelPart gambeson;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right = partdefinition.addOrReplaceChild("right",
				CubeListBuilder.create().texOffs(0, 16).mirror()
						...
						.addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.6F)).mirror(false),
				PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition left = partdefinition.addOrReplaceChild("left",
				CubeListBuilder.create().texOffs(0, 16)
						.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.3F)).texOffs(16, 16)
						.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.6F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));

		PartDefinition gambeson = partdefinition.addOrReplaceChild("gambeson",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.3F)).texOffs(24, 0)
						.addBox(-4.0F, 9.0F, -2.0F, 8.0F, 8.0F, 4.0F, new CubeDeformation(0.6F)),
