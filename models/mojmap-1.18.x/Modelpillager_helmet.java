...
public class Modelpillager_helmet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "pillager_helmet"), "main");
	private final ModelPart pillager_helmet;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition pillager_helmet = partdefinition.addOrReplaceChild("pillager_helmet",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -9.0F, -4.0F, 8.0F, 9.0F, 8.0F, new CubeDeformation(0.3F)).texOffs(0, 17)
