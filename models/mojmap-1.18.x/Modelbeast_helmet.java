...
public class Modelbeast_helmet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "beast_helmet"), "main");
	private final ModelPart pillager_horns;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition pillager_horns = partdefinition.addOrReplaceChild("pillager_horns", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.3F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition jaw_r1 = pillager_horns
				.addOrReplaceChild("jaw_r1",
						CubeListBuilder.create().texOffs(32, 20).addBox(-4.0F, -3.0F, -5.0F, 8.0F, 3.0F, 8.0F,
		...
		PartDefinition left_horn_r1 = pillager_horns.addOrReplaceChild("left_horn_r1",
				CubeListBuilder.create().texOffs(32, 6).mirror()
						.addBox(-5.61F, -15.0F, 1.0F, 1.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(32, 6).addBox(4.61F, -15.0F, 1.0F, 1.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition face_r1 = pillager_horns.addOrReplaceChild("face_r1",
				CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -32.0F, -10.0F, 8.0F, 7.0F, 8.0F,
